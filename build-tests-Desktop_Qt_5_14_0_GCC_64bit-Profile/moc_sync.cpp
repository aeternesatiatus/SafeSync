...
QT_MOC_LITERAL(1, 5, 16), // "clientDirChanged"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 16), // "clientKeyChanged"
QT_MOC_LITERAL(4, 40, 17), // "serverUserChanged"
QT_MOC_LITERAL(5, 58, 21), // "serverHostnameChanged"
QT_MOC_LITERAL(6, 80, 18) // "serverDailyChanged"

    },
    "sync\0clientDirChanged\0\0clientKeyChanged\0"
...
void sync::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->clientDirChanged(); break;
        case 1: _t->clientKeyChanged(); break;
        ...
        {
            using _t = void (sync::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&sync::clientKeyChanged)) {
                *result = 1;
                return;
            }
        }
